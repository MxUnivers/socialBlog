...
const Post = ({IdPost,content,email, authorName,  title , description , time  ,coverPicture}) => {
    return (
        <article
            class="mb-4 break-inside break-inside-avoid p-6 rounded-xl bg-white flex flex-col bg-clip-border max-w-md"
        >
                ...
                <div class="flex">
                    ...
                    <div class="flex flex-col">
                        <div class="flex items-center">
                            <a class="inline-block text-lg font-bold mr-2" href="#">{authorName}</a>
                        </div>
            ...
            <a href={`/id/post/:id`} onClick={()=>{
                localStorage.setItem("titlePost",title )
            ...
            <div class="py-4 space-y-4">
                ...
                <img class="rounded-lg max-w-full h-44"
                   src={coverPicture}
                />
            </div>
            </a>
