...
const NavBar = () => {
    return (
        <nav className=" w-full flex relative shadow justify-between items-center px-8 h-20">

            <div className="inline-flex">
                <a className="_o6689fn" href="/">
                    <svg viewBox="0 0 24 24" width={"24"}x height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" className="css-i6dzq1"><circle cx="12" cy="5" r="3"></circle><line x1="12" y1="22" x2="12" y2="8"></line><path d="M5 12H2a10 10 0 0 0 20 0h-3"></path></svg>
                </a>
            </div>
